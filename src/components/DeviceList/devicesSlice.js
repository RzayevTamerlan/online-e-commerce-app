  ...
  async (_, { getState }) => {
    ...
    if (brandFilter && typeFilter) {
      return await request(
        `https://online-e-commerce-app.vercel.app/products?brand=${brandFilter}&type=${typeFilter}&_page=${page}&_limit=16`
      );
    } else if (brandFilter) {
      return await request(
        `https://online-e-commerce-app.vercel.app/products?brand=${brandFilter}&_page=${page}&_limit=16`
      );
    } else if (typeFilter) {
      return await request(
        `https://online-e-commerce-app.vercel.app/products?&type=${typeFilter}&_page=${page}&_limit=16`
      );
    } else {
      return await request(
        `https://online-e-commerce-app.vercel.app/products?&_page=${page}&_limit=16`
      );
    }
  }
);
  ...
  async (_, { getState }) => {
    ...
    if (brandFilter && typeFilter) {
      const req = await request(
        `https://online-e-commerce-app.vercel.app/products?brand=${brandFilter}&type=${typeFilter}`
      );
      return Object.keys(req).length;
    } else if (brandFilter) {
      const req = await request(
        `https://online-e-commerce-app.vercel.app/products?brand=${brandFilter}`
      );
      return Object.keys(req).length;
    } else if (typeFilter) {
      const req = await request(
        `https://online-e-commerce-app.vercel.app/products?&type=${typeFilter}`
      );
      return Object.keys(req).length;
    } else {
      const req = await request(`https://online-e-commerce-app.vercel.app/products`);
      return Object.keys(req).length;
    }
  }
);
...
export const fetchDevice = createAsyncThunk(
  ...
  async (id) => {
    const { request } = useHttp();
    return await request(`https://online-e-commerce-app.vercel.app/products/${id}`);
  }
);
